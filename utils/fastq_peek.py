...
fastq1 = "sequenceFile/aln1.fastq"
fastq2 = "sequenceFile/aln2.fastq"
bam = "sequenceFile/aln.bam"
...
def get_fastq_df(path):
    dct = {'seq': [], 'id': [], 'qual': []}
    with open(path, "r") as fastq_handle:
...
adapters = pd.read_csv("adapters.txt", sep="\t", header=None, index_col=0)
...
df_comb.write_csv('fastq_data.txt', sep='\t')